#==================================
# AIM
#	  * Similar to REXdb_002_summarize.R, but this script focus on type II DNA transposon
#	  * They don't have "family" in REXdb, so the aim of this script is to analyze if 
#   our superfamily can match the same superfamily in REXdb by using protein similarity 
#
#==================================
...
print("# This code only work for Type II TE ====================")
...
df_rex <- read.delim2(
  ...
  mutate(
    REX_FAM = paste0(REX_CLASS, "/", REX_ORDER, "/", REX_SUPFAM, "/", 
                     REX_FAM1, "/", REX_FAM2, "/", REX_FAM3, "/", REX_FAM4), # Modify this part to include more info
...
# # make sure "REX_FAM" is not empty
# dim(df_proc_rex)
# 
# df_proc_rex %>%
#   filter(
